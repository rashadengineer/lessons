...
namespace Homework
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    summ += num;
            //}
            //Console.WriteLine("Reqemlerin toplami: " + summ);
            //Console.ReadLine();
            ...
            //int correctNum = randomNum.Next(1, user);
            //int stepNum;

            //for (int i = 1; i <= user; i++)
            //{
            //    Console.Write(i + ". " + "Cəhdiniz! Zəhmət olmasa rəqəmi təxmin edin: ");
            //    stepNum = Convert.ToInt32(Console.ReadLine());

            //    if (correctNum == stepNum)
            //    {
            //        Console.WriteLine(i + ". " + "Cəhdinizdə düzgün rəqəmi tapdınız!");
            //        break;
            //    }
            //}
            //Console.ReadLine();
